...
public class Main {
    public static void main(String[] args) {
        Book[] books = new Book[]{
                ...
                new Book(3, "Book_3", new Author[]{new Author(2, "Walter", "Peterson")}, new Publisher(1, "Publisher_1"), 1997, 350, BigDecimal.valueOf(34.99), CoverType.HARDCOVER),
                new Book(4, "Book_4", new Author[]{new Author(3, "Craig", "Gregory")}, new Publisher(3, "Publisher_3"), 1992, 185, BigDecimal.valueOf(19.99), CoverType.PAPERBACK)};
